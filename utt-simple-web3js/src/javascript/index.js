...
window.addEventListener('load', async () => {
    ...
    // Cache l'app si tu n'est pas connecté
    ...
    if (window.ethereum) {
        ...
        //Exemple de handler des evenement de wallet: pas de tout des bonnespratiques mais ça explique les principes
        ...
        // window.web3.on('connect', (connectInfo) => {
        //     window.location.reload();
        // })
        ...
        document.querySelector("#connection").addEventListener("click", async () => {
            try {
                ...
                try {
                    ...
                    // Affiche l'app après avoir connecté un wallet
